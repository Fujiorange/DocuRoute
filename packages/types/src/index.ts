...
export enum AuditAction {
  ...
  CLASSIFICATION_SOCIETY_WEBHOOK_RECEIVED = 'CLASSIFICATION_SOCIETY_WEBHOOK_RECEIVED',
  CLASSIFICATION_SOCIETY_WEBHOOK_FAILED = 'CLASSIFICATION_SOCIETY_WEBHOOK_FAILED',
}
